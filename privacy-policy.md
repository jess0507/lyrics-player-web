...
Lyrics Player ("the App") respects your privacy. This policy explains how the App collects, uses, and protects your data.
...
音訊歌詞播放器 Lyrics Player（以下稱「本應用程式」）重視您的隱私。本政策說明本應用程式如何蒐集、使用與保護您的資料。
